export const locale = {
    ...
    benefitName2: 'pages.welcome.benefits.2.name',
    benefitDescription2: 'pages.welcome.benefits.2.description',
    benefitName3: 'pages.welcome.benefits.3.name',
    benefitDescription3: 'pages.welcome.benefits.3.description',
}
