export const locales = {
    title: "pages.profile.contract.title",
    titleWithoutContract: "pages.profile.contract.no-contract",
    dateUntil: "pages.profile.contract.date-until",
    type: "pages.profile.contract.type",
    ...
    button: "pages.profile.contract.button",
}
