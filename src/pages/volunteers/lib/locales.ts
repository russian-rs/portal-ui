export const locales = {
    ...
    totalHours: "pages.mintrud.total-hours",

    programStats: "pages.mintrud.program-stats",
    program: "pages.mintrud.program",
    volunteers: "pages.mintrud.volunteers",
    hours: "pages.mintrud.hours",
    other: "pages.mintrud.other",

    volunteerStats: "pages.mintrud.volunteer-stats",
    genderFemale: "pages.mintrud.gender.female",
    genderMale: "pages.mintrud.gender.male",
    age15to18: "pages.mintrud.age.15-18",
    age18to30: "pages.mintrud.age.18-30",
    age30to40: "pages.mintrud.age.30-40",
