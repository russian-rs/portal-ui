...
export default function generateContractPdf(application: ApplicationDto) {
    ...
    pdf.text("На основу Закона о волонтирању („Службени гласник РС“, бр. 36/2010), увогорне стране:", 15, startY)
    startY = startY + 3
    ...
    const value5 = '**Удружене грађана "РУСКА ДИЈАСПОРА У СРБИJИ"**,  регистрационный номер: 28355122 ПИБ: 113526376,'
    ...
    pdf.text(
        "Шифра активности: 9499 коју представља директор Леонид Стеценко (у даљем тексту: Организатор \n" +
            "волонтера) уговорне стране су се договориле о следећем. \n\n" +
    ...
    const value9 = "**3.2. Траање (време волонтерске слујжбе)** одређује се у износу **од најмање 10 часова недељно.**"
    ...
    pdf.text(
        "3.3. Волонтер може бити укључен у догађаје у другом граду ван места пребивалишта или  боравишта. \n\n" +
            ...
            "Организатора волонтера са навођењем новог пребивалишта или  боравишта најкасније 5 дана унапред.",
        15,
        startY
    )
    startY = 20
    ...
    pdf.text(
        "4.2. Уколико волонтер нема осигурање за случај повреде и професионалне болести током волонтирања, \n" +
            "осигурање обезбеђује организатор волонтерских активности.",
        15,
        startY
    )
    startY = startY + 8
    ...
    pdf.text(
        "приступању.  \n\n" +
            "4.3. Волонтер није у обавези да волонтира у складу са упутствима организатора волонтера:  \n\n" +
            "- ако извршење налога може угрозити живот и здравље волонтера, корисника волонтирања или других лица; \n\n" +
            "- шта је морално неприхватљиво за волонтера, корисника волонтирања или друго лице; \n\n" +
            "- шта је супротно закону или овом уговору о волонтирању; \n\n" +
            "- ако примена упутства може проузроковати штету волонтеру, кориснику волонтирања или трећем лицу, \n" +
            "волонтер је дужан да писаним путем упозори организатора волонтирања. \n\n" +
            ...
            "дозволити откривање било каквих информација добијених у интеракцији са Организатором волонтера, \n" +
            "обављањем волонтерских активности без писмене сагласности Организатора волонтирања. \n\n" +
            "4.6. Волонтер има право на на безбедне и здраве услове рада и средства и опрему за личну заштиту, у \n" +
            ...
            "4.11. Организатор волонтирања се обавезује да волонтеру изда потврду о волонтирању означавајући \n" +
            "време добровољности. \n\n" +
    ...
    pdf.text(
        "5.1. Волонтер може у свако доба раскинути уговор о волонтирању на начин прописан за његово\n" +
            ...
            "5.2. Организатор волонтера може раскинути уговор о волонтерству:",
        15,
        startY
    )
    startY = 20
    ...
    pdf.text(
        "6.1. На сва питања која нису уређена овим уговором примењују се одредбе Закона и других важећих \n" +
            ...
            "6.2. Уговорне стране сагласне су да сваки спор из овог уговора или у вези са овим уговором буде коначно \n" +
            "решен арбитражом организованом у складу са правилником сталне арбитраже при удружењју руска \n" +
            "дијаспора у Србији у Новом Саду. \n\n" +
    ...
    pdf.setFontSize(6)
    pdf.setFont("Montserrat-Bold", "bold")
    pdf.text('Удружене грађана "РУСКА ДИЈАСПОРА   \n' + 'У СРБИJИ" ', 15, startY)
    startY = startY + 9

    pdf.setFont("Montserrat-Medium", "normal")
    pdf.text(
        "Урачун број 200-3624860101038-38  \n\n" +
