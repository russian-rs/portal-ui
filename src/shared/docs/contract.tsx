...
export default function generateContractPdf(application: ApplicationDto) {
    ...
    writeInlineBold(
        `**Удружење грађана "РУСКА ДИЈАСПОРА У СРБИJИ"**, матични број (МБ): 28355122 ПИБ: 113526376,`,
        BODY_PT,
        1
    )

    writeWrapped(
        `Шифра активности: 9499 које заступа директор Леонид Стеценко (у даљем тексту: Организатор волонтирања) уговорне стране су се договориле о следећем.
...
4.2. Уколико волонтер нема осигурање за случај повреде и професионалне болести током волонтирања, осигурање обезбеђује организатор волонтирања.`,
    ...
    writeInlineBold(
        "4.2.1. **Место и облик волонтирања** и друга питања утврђују се на основу упитника / изјаве о приступању.",
        BODY_PT,
        2
    )
...
4.12. Организатор волонтерских активности обезбеђује волонтеру одговарајућу обуку о волонтирању. Обука се може одвијати у формату редовне, ванредне или онлајн обуке. Облик, методе, време потребно за обуку утврђује Организатор волонтирања.`,
        BODY_PT,
        4
    )
